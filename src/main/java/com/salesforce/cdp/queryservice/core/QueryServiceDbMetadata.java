...
public enum QueryServiceDbMetadata {
    GET_CATALOGS(
    ...
    EMPTY(Collections.emptyList(), Collections.emptyList(), Collections.emptyList());;
    ...
    QueryServiceDbMetadata(List<String> columnNames,
    ...
    QueryServiceDbMetadata(QueryServiceDbMetadata base,
